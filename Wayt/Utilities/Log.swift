...
/// Centralized structured logging for Wayt.
///
...
///   subsystem: com.wayt.app   category: api | auth | search | ...
///
/// Usage:
...
enum Log {
    private nonisolated static let subsystem = Bundle.main.bundleIdentifier ?? "com.wayt.app"
