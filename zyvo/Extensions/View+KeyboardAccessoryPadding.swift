//
//  View+KeyboardAccessoryPadding.swift
//  zyvo
//
//  Created by Matteo Guidi on 2025-11-17.
//
...
private struct KeyboardAccessoryInset: ViewModifier {
...
extension View {
    ...
    func keyboardAccessoryPadding(_ insetHeight: CGFloat = 72) -> some View {
        modifier(KeyboardAccessoryInset(insetHeight: insetHeight))
    }
}
#endif
