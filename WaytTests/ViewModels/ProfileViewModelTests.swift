...
struct ProfileViewModelTests {
    ...
    private let cacheKeys = [
        "wayt_profile_totalReports",
        "wayt_profile_memberSince",
        "wayt_profile_displayName",
        "wayt_profile_imageUrl"
    ]
    ...
    func loadsCachedDataOnInit() {
        ...
        defaults.set(15, forKey: "wayt_profile_totalReports")
        defaults.set("2024-06-01", forKey: "wayt_profile_memberSince")
        defaults.set("CachedUser", forKey: "wayt_profile_displayName")
        defaults.set("https://example.com/img.jpg", forKey: "wayt_profile_imageUrl")
    ...
    func ignoresCacheWhenMemberSinceEmpty() {
        ...
        let defaults = UserDefaults.standard
        defaults.set(15, forKey: "wayt_profile_totalReports")
        defaults.set("", forKey: "wayt_profile_memberSince")
